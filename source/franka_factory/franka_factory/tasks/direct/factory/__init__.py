...
"""Factory tasks for Franka Panda robot.

Available environments:
    - Franka-Factory-PegInsert-Direct-v0
    - Franka-Factory-GearMesh-Direct-v0
    - Franka-Factory-NutThread-Direct-v0
"""
...
gym.register(
    id="Franka-Factory-PegInsert-Direct-v0",
...
gym.register(
    id="Franka-Factory-GearMesh-Direct-v0",
    entry_point=f"{__name__}.factory_env:FactoryEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Franka-Factory-NutThread-Direct-v0",
    entry_point=f"{__name__}.factory_env:FactoryEnv",
    disable_env_checker=True,
    kwargs={
