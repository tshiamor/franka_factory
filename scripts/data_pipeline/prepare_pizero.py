...
def parse_args():
    ...
    parser.add_argument("--camera", type=str, default="wrist_rgb", help="Primary camera")
    parser.add_argument("--cameras", type=str, nargs="+", default=None, help="Multiple cameras (e.g., wrist_rgb table_rgb)")
    parser.add_argument("--max_episodes", type=int, default=None)
    parser.add_argument("--fps", type=int, default=30)
    parser.add_argument("--action_horizon", type=int, default=16, help="Action chunk size")
